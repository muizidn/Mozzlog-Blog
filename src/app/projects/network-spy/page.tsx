...
export const metadata = {
  ...
  openGraph: {
    ...
    images: 'https://bmwvfjerbeswbgqrwmfp.supabase.co/storage/v1/object/public/datamozz/NetworkSpy_opengraph.png',
    description: "Network Spy is your friend to find and raise your application networking game to the next level. Monitor, inspect, and modify your network traffic in the platform you love."
  }
};
...
export default function NetworkSpyPage() {
  return (
    <ProjectTemplatePage
      ...
      waitlistCode='0ev0eN'
      image="https://bmwvfjerbeswbgqrwmfp.supabase.co/storage/v1/object/public/datamozz/NetworkSpy.png"
    />
  );
}
