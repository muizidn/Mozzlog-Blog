...
export const metadata = {
  ...
  openGraph: {
    title: "Tomio AI · The more you get from AI, the more you produce tangible results",
    type: "website",
    url: "https://bmwvfjerbeswbgqrwmfp.supabase.co/storage/v1/object/public/datamozz/tomio-banner.png",
    images: 'https://bmwvfjerbeswbgqrwmfp.supabase.co/storage/v1/object/public/datamozz/tomio-banner.png',
    description: "Tomio helps you find answers, insight, questions, and many more. You will be amazed with its skill."
  }
};
...
export default function TomioAiPage() {
  return (
    <ProjectTemplatePage
      ...
      waitlistCode='ub9Y8s'
      image="https://bmwvfjerbeswbgqrwmfp.supabase.co/storage/v1/object/public/datamozz/tomio-banner.png"
    />
  );
}
